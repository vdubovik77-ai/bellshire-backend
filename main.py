...
BASE_INSTRUCTIONS = (
    ...
    "'GUIDED TOUR'. Present that scene OUT LOUD in the SAME language you are speaking with the\n"
    "client — the scene text is written in English, so if you are talking to them in Ukrainian,\n"
    "TRANSLATE it naturally into Ukrainian (never mix languages in one sentence). Speak slowly and\n"
